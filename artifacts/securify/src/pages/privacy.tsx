      ...
      <main className="flex-1 container mx-auto px-4 md:px-8 py-16 max-w-3xl">
        ...
        <div className="space-y-10">
          <div>
            ...
            <p className="text-sm text-white/40">Last updated: April 2025</p>
          </div>
          ...
          <p className="text-white/60 leading-relaxed">
            ...
            service at <strong className="text-white">securify.works</strong>.
          </p>
          ...
          <Section title="2. Information We Collect">
            <p><strong className="text-white">Account information:</strong> When you register, we collect your email address and a hashed version of your password. We never store your password in plain text.</p>
            <p><strong className="text-white">Content you submit:</strong> Screenshots, text messages, document files, and URLs you submit for analysis are processed temporarily to generate your result. This content is not stored after analysis is complete.</p>
            <p><strong className="text-white">Usage data:</strong> We may collect anonymised usage data (pages visited, features used) to improve the service. This data cannot identify you personally.</p>
            <p><strong className="text-white">Cookies:</strong> We use a session cookie solely to keep you signed in. We do not use advertising or tracking cookies.</p>
          </Section>
          ...
          <Section title="3. How We Use Your Information">
            ...
            <p>We do <strong className="text-white">not</strong> sell your data, use it for advertising, or share it with third parties except as described below.</p>
          </Section>

          <Section title="4. Third-Party Services">
            <p>We use the following third-party services to operate Securify:</p>
            <ul className="list-disc list-inside space-y-1 pl-2">
              <li><strong className="text-white">OpenAI</strong> — AI analysis of submitted content (subject to OpenAI's data policies)</li>
              <li><strong className="text-white">Google Safe Browsing API</strong> — URL safety checking</li>
          ...
          <Section title="5. Data Retention">
            <p>
              ...
              and <strong className="text-white">not persisted to disk or any database</strong> after
          ...
          <Section title="6. Your Rights">
            ...
            <p>To exercise any of these rights, contact us at <strong className="text-white">privacy@securify.works</strong>.</p>
          </Section>
          ...
          <Section title="10. Contact Us">
            ...
            <p>
              <strong className="text-white">Email:</strong> privacy@securify.works<br />
              <strong className="text-white">Website:</strong> https://securify.works
            </p>
          </Section>
        </div>
      </main>

      <footer className="border-t border-white/8 py-8 text-center text-sm text-white/40 mt-16 bg-black">
