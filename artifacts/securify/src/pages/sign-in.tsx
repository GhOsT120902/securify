...
export function SignInPage() {
      ...
      <div className="min-h-[100dvh] flex items-center justify-center bg-black px-4">
        <AuthCard>
          <p className="text-sm text-white/60 leading-relaxed">
            Your email <strong className="text-white">{email}</strong> hasn't been verified yet.{" "}
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col items-center justify-center bg-black px-4 gap-4">
      <AuthCard>
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <p className="text-sm text-white/50">Sign in to your Securify account</p>
          </div>
