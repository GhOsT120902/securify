    ...
    <div className="min-h-[100dvh] flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 md:px-8 py-16 max-w-3xl">
        ...
        <div className="space-y-12">
          <div>
            <h1 className="text-4xl font-bold text-foreground mb-4" style={{ fontFamily: "var(--font-display)" }}>
              About Securify
            </h1>
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-2xl p-8 text-center">
            ...
            <Link href={`${basePath}/sign-up`}>
              <button className="bg-primary text-white font-medium px-6 py-2.5 rounded-xl hover:bg-primary/90 transition-colors">
                Get started free
              </button>
            </Link>
          </div>
