...
const clerkAppearance = {
  ...
  variables: {
    ...
    colorForeground: "hsl(140, 10%, 15%)",
    colorMutedForeground: "hsl(140, 10%, 40%)",
    colorDanger: "hsl(10, 60%, 50%)",
    colorBackground: "hsl(140, 20%, 98%)",
    colorInput: "hsl(140, 10%, 88%)",
    colorInputForeground: "hsl(140, 10%, 15%)",
    colorNeutral: "hsl(140, 10%, 70%)",
